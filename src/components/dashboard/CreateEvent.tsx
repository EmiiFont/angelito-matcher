            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <label className="relative flex items-center p-3 border border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:border-blue-300 dark:hover:border-blue-500 transition-colors bg-white dark:bg-gray-700">
                            <input
                                type="radio"
                        ...
                        <label className="relative flex items-center p-3 border border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:border-blue-300 dark:hover:border-blue-500 transition-colors bg-white dark:bg-gray-700">
                            <input
                                type="radio"
                                name="notificationChannel"
                                value="sms"
                ...
                <div className="p-6">
                    ...
                    <div className="mb-8">
                        <div className="flex justify-between mb-2">
                            <div className={`text-sm font-medium ${step >= 1 ? 'text-blue-600' : 'text-gray-400'}`}>Event Details</div>
                            <div className={`text-sm font-medium ${step >= 2 ? 'text-blue-600' : 'text-gray-400'}`}>Add Participants</div>
                            <div className={`text-sm font-medium ${step >= 3 ? 'text-blue-600' : 'text-gray-400'}`}>Review & Match</div>
                        </div>
