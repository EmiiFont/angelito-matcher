...
export function JoinedParticipants({ participantLink, joinedParticipants, selectJoinedParticipant }: JoinedParticipantsProps) {
    ...
    return (
        <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 sticky top-6 rounded-xl shadow-sm">
                <div className="p-0">
                                ...
                                <div key={index} className="border border-gray-200 dark:border-gray-600 rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors bg-white dark:bg-gray-700">
                                    <div className="flex items-start justify-between">
                                        ...
                                        <button
                                            ...
                                            className="ml-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 dark:from-green-400 dark:to-green-500 dark:hover:from-green-500 dark:hover:to-green-600 text-white text-xs px-3 py-1 h-7 shadow-lg transition-all duration-200 rounded-lg font-medium flex items-center"
                                        >
