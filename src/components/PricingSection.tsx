                    ...
                    <div className="border border-blue-200 dark:border-gray-700 hover:shadow-lg dark:hover:shadow-gray-800/50 transition-shadow h-full bg-white dark:bg-gray-800 rounded-lg">
                        <div className="p-5 h-full flex flex-col">
                            ...
                            <ul className="space-y-2 mb-4 flex-grow">
                                <li className="flex items-center">
                                    <CheckCircle className="h-4 w-4 text-blue-600 dark:text-blue-400 mr-2" />
                                    <span className="text-xs text-gray-600 dark:text-gray-400">15 participants each</span>
                                </li>
                                <li className="flex items-center">
                                    <CheckCircle className="h-4 w-4 text-blue-600 dark:text-blue-400 mr-2" />
                                ...
                                <li className="flex items-center">
                                    <CheckCircle className="h-4 w-4 text-blue-600 dark:text-blue-400 mr-2" />
                                    <span className="text-xs text-gray-600 dark:text-gray-400">Sms Notification</span>
                                </li>
                                <li className="flex items-center">
                                    <CheckCircle className="h-4 w-4 text-blue-600 dark:text-blue-400 mr-2" />
                                    <span className="text-xs text-gray-600 dark:text-gray-400">Whatsapp notification</span>
                                </li>
