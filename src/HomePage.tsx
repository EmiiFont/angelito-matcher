                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4">
                                <button
                                    ...
                                    className="text-gray-700 hover:text-purple-400 px-3 py-2 rounded-md text-sm font-normal transition-colors"
                                >
                                    Features
                                </button>
                                <button
                        ...
                        <div className="md:hidden">
                            <button
                                ...
                                className="text-gray-700 hover:text-purple-400 focus:outline-none"
                            >
                    ...
                    {isMenuOpen && (
                        <div className="md:hidden">
                            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-purple-200">
                                <button
                                    onClick={() => scrollToSection('features')}
                                    className="text-gray-700 hover:text-purple-400 block px-3 py-2 text-base font-normal w-full text-left"
                                >
                                    Features
                                </button>
                                <button
                                ...
                                <Button
                                    className="bg-purple-400 hover:bg-purple-500 text-white w-full mt-2"
                                    onClick={onGetStarted}
                                >
                                    Get Started
                                </Button>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <Button
                                size="lg"
                                className="bg-purple-400 hover:bg-purple-500 text-white px-8 py-3 text-lg"
                                onClick={onGetStarted}
                            >
                                Start Your Event
                            </Button>
                            <Button variant="outline" size="lg" className="border-purple-300 text-purple-500 hover:bg-purple-50 px-8 py-3 text-lg">
                                Watch Demo
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="mt-16 flex justify-center">
                        <Card className="w-full max-w-4xl shadow-2xl border-purple-200">
                            <CardContent className="p-8">
                                <div className="bg-gradient-to-r from-purple-300 to-purple-400 rounded-lg p-8 text-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <Card className="border-purple-200 hover:shadow-lg transition-shadow">
                            <CardContent className="p-6">
                                ...
                                <h3 className="text-xl font-normal text-gray-900 mb-2">Automated Notifications</h3>
                                <p className="text-gray-600">
                        ...
                        <Card className="border-purple-200 hover:shadow-lg transition-shadow">
                            <CardContent className="p-6">
                                ...
                                <h3 className="text-xl font-normal text-gray-900 mb-2">Complete Privacy</h3>
                                <p className="text-gray-600">
                        ...
                        <Card className="border-purple-200 hover:shadow-lg transition-shadow">
                            <CardContent className="p-6">
                                ...
                                <h3 className="text-xl font-normal text-gray-900 mb-2">Budget Management</h3>
                                <p className="text-gray-600">
                        ...
                        <Card className="border-purple-200 hover:shadow-lg transition-shadow">
                            <CardContent className="p-6">
                                ...
                                <h3 className="text-xl font-normal text-gray-900 mb-2">Admin Dashboard</h3>
                                <p className="text-gray-600">
                        ...
                        <Card className="border-purple-200 hover:shadow-lg transition-shadow">
                            <CardContent className="p-6">
                                ...
                                <h3 className="text-xl font-normal text-gray-900 mb-2">Custom Restrictions</h3>
                                <p className="text-gray-600">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <Card className="border-purple-200 hover:shadow-lg transition-shadow h-full">
                            <CardContent className="p-6 h-full flex flex-col">
                                ...
                                <div className="mb-4">
                                    <span className="text-3xl font-normal text-purple-400">$0</span>
                                ...
                                <Button
                                    className="w-full bg-purple-400 hover:bg-purple-500 text-white mt-auto"
                                    onClick={onGetStarted}
                                >
                                    Get Started Free
                                </Button>
                        ...
                        {/* Per Event */}
                        <Card className="border-purple-300 hover:shadow-lg transition-shadow ring-2 ring-purple-300 relative h-full">
                            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                <span className="bg-purple-400 text-white px-4 py-1 rounded-full text-sm font-normal">
                                    Most Popular
                                </span>
                            </div>
                            <CardContent className="p-6 h-full flex flex-col">
                                ...
                                <div className="mb-4">
                                    <span className="text-3xl font-normal text-purple-400">$4.99</span>
                        ...
                        <Card className="border-purple-200 hover:shadow-lg transition-shadow h-full">
                            <CardContent className="p-6 h-full flex flex-col">
                                ...
                                <div className="mb-4">
                                    <span className="text-3xl font-normal text-purple-400">$12.99</span>
