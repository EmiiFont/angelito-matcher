        ...
        <div className="min-h-screen bg-gradient-to-br from-sky-50 to-blue-100">
            ...
            <nav className="bg-white/90 backdrop-blur-sm border-b border-sky-200 sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {isMenuOpen && (
                        <div className="md:hidden">
                            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-sky-200">
                                <button
                                    onClick={() => scrollToSection('features')}
                                    className="text-gray-700 hover:text-sky-600 block px-3 py-2 text-base font-medium w-full text-left"
                                >
                                    Features
                                </button>
                                <button
            ...
            <section className="pt-16 pb-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-16 flex justify-center">
                        <Card className="w-full max-w-4xl shadow-2xl border-sky-200">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="flex items-center mb-4 md:mb-0">
                            <Gift className="h-8 w-8 text-sky-400" />
